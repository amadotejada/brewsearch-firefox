...
- 0.0.4: Added installation commands to results, smart Enter to top match, fetch retry on failure, XSS escaping in default suggestions
- 0.0.3: Added package descriptions
- 0.0.2: Initial Firefox release
